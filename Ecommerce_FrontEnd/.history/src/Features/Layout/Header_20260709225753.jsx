...
const Header = () => {
  ...
  {/* Left: Clothing / Jewelry */}
  <div className="flex items-center gap-4">
    <button
      onClick={() => navigate("/user/home?product_type=clothing")}
      className="rounded-full bg-gray-200 px-5 py-2 text-sm font-semibold text-black hover:bg-gray-300 transition"
    >
      Clothing
    </button>
  ...
  <div className="flex justify-center">
    <img src="/logo 1.png" alt="Logo" className="h-16 w-auto" onClick={() => navigate("/")} />
  </div>

  {/* Right: search + icons (your existing cart/wishlist/login) */}
