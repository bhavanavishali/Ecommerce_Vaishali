...
// import { Search, Lock, Pencil, Unlock } from "lucide-react"
...
//         // For axios-style response handling
...
//           <Button className="bg-red-800 text-white hover:bg-red-700">ADD NEW USER</Button>
...
//                         size="icon"
//                         onClick={() => {
//                           console.log(`Button clicked for user ${user.id}, current status: ${user.is_active ? 'active' : 'inactive'}`);
