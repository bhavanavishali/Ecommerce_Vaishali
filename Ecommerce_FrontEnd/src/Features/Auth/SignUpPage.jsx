...
import { Loader2, Crown, Gem, Sparkles, Diamond, GemIcon, Eye, EyeOff } from "lucide-react"
      ...
      <div className="flex min-h-screen">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8">
          <div className="w-full max-w-md">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-2xl border border-amber-200 p-5 sm:p-8">
              <div className="text-center mb-8">
                <div className="flex items-center justify-center gap-2 mb-4">
                 
                  <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#023d12] ">Create Account</h1>
                ...
                <div className="space-y-2">
                  <div className="relative">
                    <Input
                      ...
                      onChange={handleChange}
                      className="h-12 rounded-xl bg-gradient-to-r from-amber-50 to-white px-4 border-2 border-amber-200 focus:border-[#023d12]  transition-all duration-300 pr-12"
                      autoComplete="new-password"
                    />
                    <button
                      type="button"
                      onClick={() => setShowPassword(!showPassword)}
                      className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#023d12]  opacity-50 hover:opacity-70 transition-opacity"
                    >
...
>
  {isSubmitting ? (
    ...
    <div className="flex items-center justify-center gap-2">
      <Crown className="w-5 h-5 text-[#FFE08A]" />
      <span>Sign In</span>
    </div>
  )}
</Button>
