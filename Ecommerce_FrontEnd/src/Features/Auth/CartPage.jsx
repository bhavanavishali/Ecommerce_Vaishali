...
// import { useNavigate } from "react-router-dom"
// import Swal from "sweetalert2"
// import { Trash2, ShoppingBag, ChevronLeft, Plus, Minus, ArrowRight, Gift, Truck } from "lucide-react"
...
//                             <span className="text-[#a67c52] line-through text-sm">₹ {item.price.toLocaleString()}</span>
//                             <span className="text-[#7a2828] font-medium text-lg">₹ {item.final_price.toLocaleString()}</span>
//                             <span className="text-green-600 text-xs">
//                               Save ₹ {(item.price - item.final_price).toLocaleString()}
//                             </span>
//                           </div>
//                         ) : (
//                           <span className="text-[#7a2828] font-medium text-lg">₹ {item.final_price.toLocaleString()}</span>
...
//                     </span>
//                     <span className="text-green-600">- ₹ {cart.total_discount.toLocaleString()}</span>
//                   </div>
//                 )}
