    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-rose-50">
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-[#023d12]  mb-4">Contact Us</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <Card className="p-6 border-0 shadow-lg bg-white/90 backdrop-blur-sm">
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-[#023d12]  p-3 rounded-full text-white mr-4">
            ...
            <Card className="p-6 border-0 shadow-lg bg-white/90 backdrop-blur-sm">
              <h3 className="text-xl font-semibold text-[#023d12]  mb-4 flex items-center">
                <Diamond className="h-5 w-5 mr-2" />
                Our Jewelry Services
              </h3>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-center">
                  <div className="w-2 h-2 rounded-full bg-[#023d12]  mr-2"></div>
            ...
            <div>
              <h3 className="text-xl font-semibold text-[#023d12]  mb-4">Follow Us</h3>
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="bg-[#023d12]  hover:bg-[#5e1e1e] text-white p-3 rounded-full transition-colors"
                  aria-label="Facebook"
                >
          ...
          <div>
            <Card className="p-6 border-0 shadow-lg bg-white/90 backdrop-blur-sm">
              <h2 className="text-2xl font-bold text-[#023d12]  mb-6">Send Us a Message</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  className="w-full bg-[#023d12]  hover:bg-[#5e1e1e] text-white"
            ...
            <div className="mt-8 p-6 bg-[#023d12] /10 rounded-lg border border-[#023d12] /20">
              <h3 className="text-lg font-semibold text-[#023d12]  mb-2">Jewelry Consultation</h3>
              ...
              <Button variant="outline" className="border-[#023d12]  text-[#023d12]  hover:bg-[#023d12]  hover:text-white">
                Book Appointment
              </Button>
            </div>
          </div>
        ...
        <div className="mt-16">
          <h2 className="text-2xl font-bold text-[#023d12]  mb-6 text-center">Visit Our Showroom</h2>
